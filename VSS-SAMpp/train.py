...
parser.add_argument('--base_lr', type=float, default=0.0004, help='segmentation network learning rate')
...
parser.add_argument('--warmup_period', type=int, default=2000, help='Warp up iterations, only valid when warmup is activated')
